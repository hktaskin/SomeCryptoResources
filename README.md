...
## Popular softwares that use cryptography
...
### Random File Generate Commands
* dd if=/dev/random of=random.bin bs=1m count=1
* dd if=/dev/urandom of=urandom.bin bs=1m count=1
...
* https://web.archive.org/web/20011218002449/http://csrc.nist.gov/encryption/aes/index2.html
...
## Math and Crypto Puzzles/Challenges
